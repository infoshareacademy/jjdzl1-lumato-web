...
let formToValidate = {
    submit: {
        input: false,
        element: document.getElementById("extra-cost-input:submit-new-extra-cost"),
        color: "",
    ...
    extraCostPrice: {
        input: true,
        element: document.getElementById("extra-cost-input:extra-cost-price"),
        color: "",
        ok: false,
    ...
    description: {
        input: true,
        element: document.getElementById("extra-cost-input:description"),
        color: "",
        ok: false,
    ...
    extraCostDate: {
        input: true,
        element: document.getElementById("extra-cost-input:extra-cost-date"),
        color: "",
        ok: false,
    ...
    otherVerifyFunctions: {
        validateExtraCostPriceMoreThanZero: function() {
            if (formToValidate.extraCostPrice.element.value < 0) {
